...
async function sendQuotationNotification({ clientName, phone, email, detailsSummary, cameraImage }) {
    ...
    attachments: [
      {
        ...
        path: path.join(__dirname, '../public/images/hero-bg.jpg'),
        cid: 'suryadrishti_banner'
      },
      {
        filename: 'camera.jpg',
        path: path.join(__dirname, '../' + camImgPath),
        cid: 'camera_image'
      }
    ]
  };
