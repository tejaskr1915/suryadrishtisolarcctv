...
const apiService = {
    // PRODUCTS (PIM)
    getProducts: async ()=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$dbMock$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].getProducts();
    },
    ...
    duplicateProduct: async (id)=>{
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$dbMock$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].saveProduct(duplicate);
    },
    // CATEGORIES
    getCategories: async ()=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$dbMock$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].getCategories();
    },
    ...
    // COMPATIBILITY RULES
    getRules: async ()=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$dbMock$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].getRules();
    },
    saveRule: async (rule)=>{
    ...
    // AUDIT LOGS
    getLogs: async ()=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$dbMock$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].getLogs();
    },
    ...
    // ORDERS & QUOTATIONS
    getOrders: async ()=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$dbMock$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].getOrders();
    },
    ...
    // SERVICE REQUESTS
    getServices: async ()=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$dbMock$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].getServices();
    },
    ...
    // GALLERY
    getGallery: async ()=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$dbMock$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].getGallery();
    },
    ...
    getAnalytics: async ()=>{
        const products = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$dbMock$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].getProducts();
        const orders = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$dbMock$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].getOrders();
        const categories = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$dbMock$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].getCategories();
        const logs = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$dbMock$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].getLogs();
        const totalProducts = products.length;
        const activeProducts = products.filter((p)=>p.status === 'Active').length;
        const draftProducts = products.filter((p)=>p.status === 'Draft').length;
        const featuredProducts = products.filter((p)=>p.sku && p.sku.includes('PTZ')).length; // mock featured indicator
        // Inventory & Low Stock Alerts
        const lowStockAlerts = products.filter((p)=>p.stockQuantity <= p.lowStockThreshold);
        const outOfStockCount = products.filter((p)=>p.stockQuantity === 0).length;
        // Revenue calculations (assuming quote approvals mock a value)
        const approvedOrders = orders.filter((o)=>o.status === 'Accepted');
        const totalSales = approvedOrders.length;
        // Sum pricing breakdowns (assuming default model rates from DB details)
        const revenue = approvedOrders.reduce((sum, order)=>{
            // Calculate order total based on hardware
            ...
            return sum + (cam.price + bat.price + pan.price + card.price + accSum);
        }, 0);
        return {
            totalProducts,
            activeProducts,
...
//# sourceMappingURL=src_12fs25k._.js.map