        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16">
          <div>
            <span className="text-electric-cyan text-xs font-space uppercase tracking-widest block mb-3 font-semibold">
              <span className="font-kannada">ಕ್ಯಾಮೆರಾ ಹೋಲಿಕೆ</span> / Compare Models
            </span>
            <h2 className="text-4xl md:text-5xl font-light text-white leading-tight">
              <span className="font-kannada">ಸಂವಾದಾತ್ಮಕ ಹೋಲಿಕೆ</span> / Interactive Comparison
            </h2>
            <p className="text-zinc-400 font-light mt-3 max-w-xl">
              <span className="font-kannada">ಆಪ್ಟಿಕ್ಸ್, ರಾತ್ರಿ ದೃಷ್ಟಿ ಸಾಮರ್ಥ್ಯಗಳು ಮತ್ತು ಸ್ವಾಯತ್ತ ಟ್ರ್ಯಾಕಿಂಗ್ ನಿಯತಾಂಕಗಳನ್ನು ಅಕ್ಕಪಕ್ಕದಲ್ಲಿ ಹೋಲಿಸಲು ಯಾವುದೇ ಎರಡು ಕ್ಯಾಮೆರಾ ಮಾದರಿಗಳನ್ನು ಆಯ್ಕೆಮಾಡಿ.</span> / Select any two camera models to compare their optics, night vision capabilities, and autonomous tracking parameters side-by-side.
            </p>
          </div>
          ...
          <div className="mt-6 md:mt-0">
            ...
            >
              <span className="font-kannada">ವ್ಯತ್ಯಾಸಗಳನ್ನು ಗುರುತಿಸಿ</span> / Highlight Differences
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="glass-panel p-5 rounded-2xl border border-white/5 bg-zinc-900/20">
            <span className="text-[9px] text-zinc-500 uppercase tracking-widest font-space block mb-3 font-semibold">
              <span className="font-kannada">ಕ್ಯಾಮೆರಾ 1 ಆಯ್ಕೆಮಾಡಿ</span> / Choose Camera 1
            </span>
          ...
          <div className="glass-panel p-5 rounded-2xl border border-white/5 bg-zinc-900/20">
            <span className="text-[9px] text-zinc-500 uppercase tracking-widest font-space block mb-3 font-semibold">
              <span className="font-kannada">ಕ್ಯಾಮೆರಾ 2 ಆಯ್ಕೆಮಾಡಿ</span> / Choose Camera 2
            </span>
            <div className="flex gap-3 flex-wrap">
              {solarCameras.map(cam => {
              ...
              <thead>
                <tr className="border-b border-zinc-800/80 bg-zinc-950/40">
                  <th className="p-6 font-space text-zinc-500 uppercase tracking-widest text-[9px] w-[220px]">
                    <span className="font-kannada">ವಿಶೇಷಣಗಳು</span> / Specifications
                  </th>
                  ...
                  <th className="p-6 w-[250px] border-r border-zinc-900 text-center">
                    ...
                    >
                      <span className="font-kannada">ಕಾನ್ಫಿಗರ್ ಮಾಡಿ</span> / Configure Node <ArrowRight className="w-3 h-3 group-hover:translate-x-1 transition-transform" />
                    </button>
                  </th>
              ...
              <tbody className="divide-y divide-zinc-900/50">
                ...
                <tr className={`hover:bg-white/5 transition-colors ${highlightDifferences && isDiff('nightVision') ? 'bg-electric-cyan/5 border-l-2 border-electric-cyan' : ''}`}>
                  <td className="p-6 font-medium text-[11px] text-zinc-400 flex items-center gap-2">
                    <Eye className="w-4 h-4 text-electric-cyan" /> <span className="font-kannada">ರಾತ್ರಿ ದೃಷ್ಟಿ ಸಾಮರ್ಥ್ಯ</span> / Night Vision Gaze
                  </td>
                ...
                <tr className={`hover:bg-white/5 transition-colors ${highlightDifferences && isDiff('zoom') ? 'bg-electric-cyan/5 border-l-2 border-electric-cyan' : ''}`}>
                  <td className="p-6 font-medium text-[11px] text-zinc-400 flex items-center gap-2">
                    <ZoomIn className="w-4 h-4 text-electric-cyan" /> <span className="font-kannada">ಹೈಬ್ರಿಡ್ ಆಪ್ಟಿಕ್ಸ್ ಜೂಮ್</span> / Hybrid Optics Zoom
                  </td>
                  <td className="p-6 text-zinc-200 font-light border-r border-zinc-900">
                ...
                <tr className={`hover:bg-white/5 transition-colors ${highlightDifferences && isDiff('humanDetection') ? 'bg-electric-cyan/5 border-l-2 border-electric-cyan' : ''}`}>
                  <td className="p-6 font-medium text-[11px] text-zinc-400 flex items-center gap-2">
                    <Target className="w-4 h-4 text-electric-cyan" /> <span className="font-kannada">ಎಐ ಟಾರ್ಗೆಟ್ ಟ್ರೇಸಿಂಗ್</span> / AI Target Tracing
                  </td>
                  <td className="p-6 text-zinc-200 font-light border-r border-zinc-900">
                ...
                <tr className={`hover:bg-white/5 transition-colors ${highlightDifferences && isDiff('motionDetection') ? 'bg-electric-cyan/5 border-l-2 border-electric-cyan' : ''}`}>
                  <td className="p-6 font-medium text-[11px] text-zinc-400 flex items-center gap-2">
                    <Zap className="w-4 h-4 text-electric-cyan" /> <span className="font-kannada">ಪಿಐಆರ್ ಚಲನೆ ಪತ್ತೆ</span> / PIR Motion Sweep
                  </td>
                  <td className="p-6 text-zinc-200 font-light border-r border-zinc-900">
                ...
                <tr className={`hover:bg-white/5 transition-colors ${highlightDifferences && isDiff('twoWayAudio') ? 'bg-electric-cyan/5 border-l-2 border-electric-cyan' : ''}`}>
                  <td className="p-6 font-medium text-[11px] text-zinc-400 flex items-center gap-2">
                    <AudioLines className="w-4 h-4 text-electric-cyan" /> <span className="font-kannada">ಆಡಿಯೋ ಇಂಟರ್‌ಕಾಮ್</span> / Audio Intercom
                  </td>
                  <td className="p-6 text-zinc-200 font-light border-r border-zinc-900">
                ...
                <tr className={`hover:bg-white/5 transition-colors ${highlightDifferences && isDiff('storage') ? 'bg-electric-cyan/5 border-l-2 border-electric-cyan' : ''}`}>
                  <td className="p-6 font-medium text-[11px] text-zinc-400 flex items-center gap-2">
                    <HardDrive className="w-4 h-4 text-electric-cyan" /> <span className="font-kannada">ಮೆಮೊರಿ ಸ್ಟೋರೇಜ್ ಕಾರ್ಡ್</span> / Memory Storage Card
                  </td>
                  <td className="p-6 text-zinc-200 font-light border-r border-zinc-900">
                ...
                <tr className={`hover:bg-white/5 transition-colors ${highlightDifferences && isDiff('warranty') ? 'bg-electric-cyan/5 border-l-2 border-electric-cyan' : ''}`}>
                  <td className="p-6 font-medium text-[11px] text-zinc-400 flex items-center gap-2">
                    <ShieldCheck className="w-4 h-4 text-electric-cyan" /> <span className="font-kannada">ತಯಾರಕರ ವಾರಂಟಿ</span> / Manufacturer Warranty
                  </td>
                  <td className="p-6 text-zinc-200 font-light border-r border-zinc-900">
