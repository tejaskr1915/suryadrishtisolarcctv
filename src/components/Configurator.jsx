      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex justify-center mb-12">
          <div className="p-1 rounded-2xl glass-panel border border-white/5 flex gap-2 w-full max-w-md">
            ...
            >
              <span className="font-kannada block text-[10px] normal-case">ಸೌರ ಸಿಸಿಟಿವಿ ವ್ಯವಸ್ಥೆ</span>
              Solar CCTV System
            </button>
            <button
              onClick={() => {
            ...
            >
              <span className="font-kannada block text-[10px] normal-case">ವಿದ್ಯುತ್ ಸಿಸಿಟಿವಿ ವ್ಯವಸ್ಥೆ</span>
            ...
            {store.configType === 'solar' ? (
              ...
              <div>
                ...
                <div className="flex items-center gap-2 p-2 rounded-2xl glass-panel border border-white/5 mb-8 overflow-x-auto">
                  {[
                    { step: 1, label: <><span className="font-kannada">ಕ್ಯಾಮೆರಾ</span> / Camera</>, icon: Shield },
                    { step: 2, label: <><span className="font-kannada">ಬ್ಯಾಟರಿ</span> / Battery</>, icon: Battery },
                    { step: 3, label: <><span className="font-kannada">ಸೌರ ಫಲಕ</span> / Panel</>, icon: Sun },
                    { step: 4, label: <><span className="font-kannada">ಮೆಮೊರಿ</span> / Storage</>, icon: HardDrive },
                    { step: 5, label: <><span className="font-kannada">ಪರಿಕರಗಳು</span> / Accessories</>, icon: Wrench },
                    { step: 6, label: <><span className="font-kannada">ಸಾರಾಂಶ</span> / Summary</>, icon: Layers },
                    { step: 7, label: <><span className="font-kannada">ಸಂಪರ್ಕ</span> / Contact</>, icon: User }
                  ].map(s => (
                    <button
                      key={s.step}
                ...
                <div className="glass-panel p-6 md:p-8 rounded-3xl border border-white/5 bg-zinc-950/20 mb-8 min-h-[380px]">
                   ...
                   {solarStep < 6 && (
                     <div className="flex justify-between items-center pb-6 mb-8 border-b border-white/5">
                       ...
                       >
                         <span className="font-kannada">ಹಿಂದೆ</span> / Back
                       </button>
                       <button
                         type="button"
                       ...
                       >
                         <span className="font-kannada">ಮುಂದಿನ ಹಂತ</span> / Next Step
                       </button>
                     </div>
                   )}
                  ...
                  {solarStep === 1 && (
                    <div>
                      <h3 className="text-xl text-white mb-2">
                        <span className="font-kannada">ಎಐ ಕ್ಯಾಮೆರಾ ಮಾದರಿಯನ್ನು ಆರಿಸಿ</span> / Choose AI Camera Model
                      </h3>
                      <p className="text-xs text-zinc-500 mb-6 font-space uppercase">
                        <span className="font-kannada">ನಮ್ಮ ಐದು ಸೌರ ಆಪ್ಟಿಕಲ್ ಸೆನ್ಸಾರ್‌ಗಳಿಂದ ಆಯ್ಕೆಮಾಡಿ</span> / Select from our five solar optical sensors by visual design
                      </p>
                        ...
                        {solarCameras.map(cam => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="relative w-full aspect-square rounded-2xl overflow-hidden border border-white/5 bg-zinc-950 flex items-center justify-center mb-4 group/img">
                                <img src={cam.image} alt="Solar Camera Model" className="w-full h-full object-contain p-4 transition-transform duration-300 group-hover/img:scale-105" />
                                ...
                                >
                                  <div className="w-12 h-12 rounded-full bg-electric-cyan text-black flex items-center justify-center shadow-lg font-bold">
                              ...
                              <div className="space-y-3">
                                <div>
                                  <span className="text-[9px] text-zinc-500 uppercase tracking-widest font-space font-medium block">
                                    <span className="font-kannada">ಸ್ವಾಯತ್ತ ದೃಷ್ಟಿ ನೋಡ್</span> / Autonomous Vision Node
                                  </span>
                                  <h4 className="text-sm font-space font-medium text-white block mt-0.5">
                                    {renderProductName(cam.name)}
                                  </h4>
                                </div>
                                <p className="text-[11px] text-zinc-400 font-light leading-relaxed min-h-[44px]">
                                  {renderProductDescription(cam.description)}
                                </p>
                                
                                <div className="text-right shrink-0 w-full md:w-auto border-t md:border-0 pt-3 md:pt-0 flex md:flex-col justify-between items-center gap-2">
                                  <button
                                    onClick={(e) => {
                                      e.stopPropagation();
                                  ...
                                  >
                                    <span className="font-kannada">ವೈಶಿಷ್ಟ್ಯಗಳನ್ನು ವೀಕ್ಷಿಸಿ</span> / View Features
                                  </button>
                                </div>
                              </div>
                            </div>
                  ...
                  {solarStep === 7 && (
                    <div>
                      ...
                      <form onSubmit={handleSolarSubmit} className="space-y-4">
                        ...
                        >
                          {store.isSubmitting ? (
                            <><RefreshCw className="w-4 h-4 animate-spin" /> <span className="font-kannada">ಉಲ್ಲೇಖವನ್ನು ಉಳಿಸಲಾಗುತ್ತಿದೆ...</span> / Saving quote...</>
                          ) : (
                            <><span className="font-kannada">ಸೌರ ಉಲ್ಲೇಖ ಸಲ್ಲಿಸಿ ಮತ್ತು ಪಿಡಿಎಫ್ ರಚಿಸಿ</span> / Submit Solar Quote & Generate PDF</>
                          )}
                        </button>
                      </form>
                    </div>
              ...
              /* ELECTRIC CCTV PAGE */
              <div className="glass-panel p-6 md:p-8 rounded-3xl border border-white/5 bg-zinc-950/20">
                <h3 className="text-xl text-white mb-6">
                  <span className="font-kannada">ವಿದ್ಯುತ್ ಸಿಸಿಟಿವಿ ಕಾನ್ಫಿಗರೇಶನ್</span> / Configure Electric CCTV
                </h3>
                ...
                <form onSubmit={handleElectricSubmit} className="space-y-6">
                  ...
                  <div>
                    <label className="text-[10px] text-zinc-500 uppercase tracking-widest font-space block mb-3">
                      <span className="font-kannada">ಕ್ಯಾಮೆರಾ ಲೈನ್ ಆಯ್ಕೆಮಾಡಿ</span> / Choose Camera Line
                    </label>
                    <div className="grid grid-cols-3 gap-3">
                      {['WiFi Camera', 'IP Camera', 'IR Camera'].map(cls => (
                        <button
                          ...
                          className={`py-3 rounded-xl border font-space text-xs uppercase tracking-wider transition-all duration-300 cursor-pointer ${
                            store.electricClass === cls
                              ? 'border-electric-cyan bg-electric-cyan/5 text-electric-cyan glow-cyan'
                              : 'border-zinc-900 bg-zinc-950/40 text-zinc-400 hover:border-zinc-800'
                          }`}
                        >
                          {cls === 'WiFi Camera' ? <><span className="font-kannada block text-[10px] normal-case">ವೈಫೈ ಕ್ಯಾಮೆರಾ</span> WiFi Camera</> :
                           cls === 'IP Camera' ? <><span className="font-kannada block text-[10px] normal-case">ಐಪಿ ಕ್ಯಾಮೆರಾ</span> IP Camera</> :
                           <><span className="font-kannada block text-[10px] normal-case">ಐಆರ್ ಕ್ಯಾಮೆರಾ</span> IR Camera</>}
                        </button>
                      ))}
                    </div>
                  </div>
                  ...
                  {store.electricClass === 'WiFi Camera' ? (
                    <div>
                      <label className="text-[10px] text-zinc-500 uppercase tracking-widest font-space block mb-3">
                        <span className="font-kannada">ವೈಫೈ ಕ್ಯಾಮೆರಾ ಮಾದರಿಯನ್ನು ಆಯ್ಕೆಮಾಡಿ</span> / Select WiFi Camera Model
                      </label>
                        ...
                        {solarCameras.map(cam => {
                          ...
                          return (
                            <div
                              key={cam.id}
                              onClick={() => store.setSolarCamera(cam)}
                              className={`p-3 rounded-2xl border transition-all duration-300 cursor-pointer flex flex-col items-center justify-between text-center ${
                                isSelected 
                                  ? 'bg-electric-cyan/5 border-electric-cyan glow-cyan' 
                                  : 'bg-zinc-950/60 border-zinc-900 hover:border-zinc-800'
                              }`}
                            >
                              <div className="w-12 h-12 bg-zinc-950 rounded-xl overflow-hidden flex items-center justify-center p-1 mb-2">
                    ...
                    <div>
                      <label className="text-[10px] text-zinc-500 uppercase tracking-widest font-space block mb-3">
                        <span className="font-kannada">ರೆಸಲ್ಯೂಶನ್ ದರ್ಜೆ</span> / Resolution Grade
                      </label>
                  ...
                  <div>
                    <label className="text-[10px] text-zinc-500 uppercase tracking-widest font-space block mb-3">
                      <span className="font-kannada">ಕ್ಯಾಮೆರಾಗಳ ಸಂಖ್ಯೆ</span> / Camera Quantity Nodes
                    </label>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <label className="text-[10px] text-zinc-500 uppercase tracking-widest font-space block mb-2.5">
                        <span className="font-kannada">ಸಂಗ್ರಹಣಾ ಸಾಮರ್ಥ್ಯ</span> / Storage Capacity
                      </label>
                      <select
                      ...
                      >
                        {store.electricClass === 'WiFi Camera' ? (
                          <>
                            <option value="64GB">64GB ಮೆಮೊರಿ ಕಾರ್ಡ್ / 64GB Memory Card</option>
                            <option value="128GB">128GB ಮೆಮೊರಿ ಕಾರ್ಡ್ / 128GB Memory Card</option>
                          </>
                        ) : (
                          <>
                            <option value="500GB">500GB ಸಿಸಿಟಿವಿ ಸಂಗ್ರಹಣೆ / 500GB CCTV Storage</option>
                            <option value="1TB">1TB ಸಿಸಿಟಿವಿ ಸಂಗ್ರಹಣೆ / 1TB CCTV Storage</option>
                            <option value="2TB">2TB ಸಿಸಿಟಿವಿ ಸಂಗ್ರಹಣೆ / 2TB CCTV Storage</option>
                            <option value="4TB">4TB ಸಿಸಿಟಿವಿ ಸಂಗ್ರಹಣೆ / 4TB CCTV Storage</option>
                          </>
                        )}
                      </select>
                    </div>
                    ...
                    <div>
                      <label className="text-[10px] text-zinc-500 uppercase tracking-widest font-space block mb-2.5">
                        <span className="font-kannada">ಸ್ಥಾಪನಾ ವ್ಯಾಪ್ತಿ</span> / Installation Scope
                      </label>
                      <select
                        ...
                        className="w-full bg-zinc-900 border border-zinc-800 rounded-xl p-3 text-xs text-white focus:outline-none"
                      >
                        <option value="Indoor">ಒಳಾಂಗಣ ಮಾತ್ರ / Indoor Only</option>
                        <option value="Outdoor">ಹೊರಾಂಗಣ ಮಾತ್ರ / Outdoor Only</option>
                        <option value="Mixed">ಮಿಶ್ರ ಒಳಾಂಗಣ ಮತ್ತು ಹೊರಾಂಗಣ / Mixed Indoor & Outdoor</option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div className="bg-zinc-950/80 rounded-2xl border border-white/5 p-5 text-xs text-center leading-relaxed">
                    <span className="text-electric-cyan font-space uppercase block mb-1 font-semibold">
                      <span className="font-kannada">ಕಸ್ಟಮ್ ಬೆಲೆ ಉಲ್ಲೇಖ</span> / Custom Pricing Quote
                    </span>
                    <span className="font-kannada">ನಮ್ಮ ಆಡಳಿತ ತಂಡವು ಮಿಶ್ರ ಲೇಔಟ್ ನೋಡ್ ಸಂಖ್ಯೆಯನ್ನು ಪರಿಶೀಲಿಸಲು ಮತ್ತು ಕಸ್ಟಮ್ ಇನ್‌ವಾಯ್ಸ್ ಉಲ್ಲೇಖವನ್ನು ಒದಗಿಸಲು ವಾಟ್ಸಾಪ್ ಅಥವಾ ಫೋನ್ ಕರೆ ಮೂಲಕ ಸಂಪರ್ಕಿಸುತ್ತದೆ.</span> / Our admin team will reach out via WhatsApp or phone call to review your mixed layout node count and supply a custom invoice quote.
                  </div>

                  {/* Customer Information forms */}
                  <div className="border-t border-zinc-900 pt-6 space-y-4">
                    <h4 className="text-md text-white mb-2 font-space">
                      <span className="font-kannada">ಸ್ಥಾಪನಾ ವಿವರಗಳು</span> / Installation details
                    </h4>
                  ...
                  >
                    {store.isSubmitting ? (
                      <><RefreshCw className="w-4 h-4 animate-spin" /> <span className="font-kannada">ಆರ್ಡರ್ ಉಳಿಸಲಾಗುತ್ತಿದೆ...</span> / Saving order...</>
                    ) : (
                      <><span className="font-kannada">ಸ್ಥಾಪನೆ ಬುಕ್ ಮಾಡಿ ಮತ್ತು ಉಲ್ಲೇಖವನ್ನು ಪಡೆಯಿರಿ</span> / Book Installation & Generate Quote</>
                    )}
                  </button>
                </form>
              </div>
          ...
          <div className="lg:col-span-5 sticky top-32 glass-panel rounded-3xl p-6 border border-white/5 flex flex-col items-center min-h-[500px]">
            <div className="w-full flex justify-between items-center border-b border-zinc-900 pb-4 mb-8">
              <span className="text-xs text-zinc-400 font-space uppercase tracking-widest">
                <span className="font-kannada">ಕಾನ್ಫಿಗರೇಶನ್ ರೆಂಡರರ್</span> / Configuration Renderer
              </span>
              <span className="text-[10px] text-zinc-500 font-space uppercase">
                <span className="font-kannada">ತ್ವರಿತ ವೀಕ್ಷಣೆ</span> / Instant view
              </span>
            </div>
            ...
            <div className="relative w-full h-[250px] border border-white/5 rounded-2xl overflow-hidden bg-zinc-950/80 flex items-center justify-center mb-8 shadow-inner group">
              ...
              <div className="absolute bottom-4 left-4 right-4 z-20 flex justify-between items-center text-[10px] font-space text-zinc-400">
                <span className="flex items-center gap-1">
                  ...
                  {store.configType === 'solar' ? <><span className="font-kannada">ಸೌರ ಲೂಪ್</span> / Solar Loop</> : <><span className="font-kannada">ಗ್ರಿಡ್ ಲೂಪ್</span> / Grid Loop</>}
                </span>
                <span>
                  {store.configType === 'solar' ? <><span className="font-kannada">ಸೌರ ಸಿಸಿಟಿವಿ</span> / Solar CCTV</> : <><span className="font-kannada">ವಿದ್ಯುತ್ ಸಿಸಿಟಿವಿ</span> / Electric CCTV</>}
                </span>
              </div>
            </div>
            ...
            <div className="w-full space-y-3 leading-relaxed text-xs">
              <span className="text-[9px] text-zinc-500 uppercase tracking-widest font-space block border-b border-zinc-900 pb-1.5 font-medium">
                <span className="font-kannada">ಕಾನ್ಫಿಗರೇಶನ್ ವಿವರಣೆಗಳು</span> / Configuration specifications
              </span>
              
              {store.configType === 'solar' ? (
                <>
                  <div className="flex justify-between">
                    <span className="text-zinc-500"><span className="font-kannada">ಕ್ಯಾಮೆರಾ ನೋಡ್:</span> / Camera Node:</span>
                    <span className="text-zinc-300 font-medium">{renderProductName(store.solarCamera?.name)}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-zinc-500"><span className="font-kannada">ಬ್ಯಾಟರಿ ಸಂಗ್ರಹಣೆ:</span> / LFP Battery Storage:</span>
                    <span className="text-zinc-300 font-medium">{renderBatteryName(store.solarBattery?.name)} ({store.solarBattery?.capacity})</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-zinc-500"><span className="font-kannada">ಸೌರ ಫಲಕ:</span> / Albedo Solar input:</span>
                    ...
                    <div className="border-t border-zinc-900/60 pt-2 space-y-1">
                      ...
                      {store.solarAccessories.map(a => (
                        <div key={a.id} className="flex justify-between pl-2">
                          ...
                          <span className="text-zinc-300"><span className="font-kannada">ಆಯ್ಕೆಮಾಡಲಾಗಿದೆ</span> / Selected</span>
                        </div>
                      ))}
                    </div>
                  )}
                ...
                <>
                  <div className="flex justify-between">
                    <span className="text-zinc-500"><span className="font-kannada">ಕ್ಯಾಮೆರಾ ಶ್ರೇಣಿ:</span> / Category Line:</span>
                    <span className="text-zinc-300 font-medium">
                      {store.electricClass === 'WiFi Camera' ? <><span className="font-kannada">ವೈಫೈ ಕ್ಯಾಮೆರಾ</span> / WiFi Camera</> :
                       ...
                       <><span className="font-kannada">ಐಆರ್ ಕ್ಯಾಮೆರಾ</span> / IR Camera</>} ({store.electricQty} <span className="font-kannada">ಯುನಿಟ್‌ಗಳು</span> / units)
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-zinc-500"><span className="font-kannada">ಸಂಗ್ರಹಣಾ ಗಾತ್ರ:</span> / Storage Size:</span>
                    <span className="text-zinc-300 font-medium">{store.electricStorage}</span>
                  </div>
                  {store.getElectricBreakdown().dvrModel && (
                    <div className="flex justify-between">
                      <span className="text-zinc-500">
                        {store.getElectricBreakdown().dvrModel.includes('DVR') ? <><span className="font-kannada">ಡಿವಿಆರ್ ರ್ಯಾಕ್:</span> / DVR Rack:</> : <><span className="font-kannada">ಎನ್‌ವಿಆರ್ ರ್ಯಾಕ್:</span> / NVR Rack:</>}
                      </span>
                      <span className="text-zinc-300 font-medium">
                        {store.getElectricBreakdown().dvrModel}
                      </span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col gap-4">
                ...
                {previewCamera.videoUrl && (
                  ...
                  >
                    <Play className="w-4 h-4" /> <span className="font-kannada">ಡೆಮೊ ಪ್ಲೇ ಮಾಡಿ</span> / Play Demo
                  </button>
                )}
              </div>
              ...
              <div className="flex flex-col justify-between space-y-4">
                ...
                <div className="pt-4 flex gap-3">
                  ...
                  >
                    <span className="font-kannada">ಆಯ್ಕೆಮಾಡಿ</span> / Select Camera Node
                  </button>
                </div>
              </div>
            </div>
